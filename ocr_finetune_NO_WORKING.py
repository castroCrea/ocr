...
obj_detector = pipeline("object-detection", model="./models/detr-resnet-50_finetuned_cppe5/checkpoint-1000")
...
# processor = DetrImageProcessor.from_pretrained("./models/detr-resnet-50_finetuned_cppe5/checkpoint-1200", local_files_only=True, revision="no_timm")
# model = DetrForObjectDetection.from_pretrained("./models/detr-resnet-50_finetuned_cppe5/checkpoint-1200", local_files_only=True, revision="no_timm")
